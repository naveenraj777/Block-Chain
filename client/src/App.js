  ...
  render() {
    ...
    return (
      <div className="App">
        ...
        <h2>Items</h2>
        <h2>Add Items</h2>
        Cost in Wei   :  <input type='text' name='cost' value={this.state.cost} onChange={this.handleInputChange} /><br></br><br></br>
        Item identifier :  <input type='text' name='itemName' value={this.state.itemName} onChange={this.handleInputChange} /><br></br><br></br>
        <button class="button" type='button' onClick={this.handleSubmit}>Create new item</button>
      </div>
    );
  }
}
